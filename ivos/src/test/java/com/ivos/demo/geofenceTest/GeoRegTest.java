...
public class GeoRegTest {
    ...
    @Transactional
     void add() throws Exception {
        String urlPath = "/v1/geofence/save";
        mockMvc.perform(post(urlPath)
                        .param("name","围栏01")
                        .param("position","{type: rectangle, recPoints: 116.40165084473607-39.90187424090239,116.416311190…37068651884,116.40165084473607-39.896837068651884}"))
